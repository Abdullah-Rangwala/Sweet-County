    ...
    .then(async () => {
        ...
        if (productCount < 10) {
            ...
            await Product.insertMany([
                ...
                { name: 'Pineapple Paradise', category: 'Cakes', price: 480, description: 'Moist pineapple cake with candied pineapple rings on top.', image: 'https://images.unsplash.com/photo-1627834377105-37a0e83f4b60?w=500', rating: 4.4 },
                { name: 'Cheesecake Classic', category: 'Cakes', price: 680, description: 'New York-style baked cheesecake with a buttery graham base.', image: 'https://images.unsplash.com/photo-1524351199432-ca330dccd553?w=500', rating: 4.8 },
                ...
                { name: 'Chocolate Eclair', category: 'Pastries', price: 120, description: 'Choux pastry filled with rich chocolate custard and glazed.', image: 'https://images.unsplash.com/photo-1525203007316-54b8a87e73c4?w=500', rating: 4.6 },
                { name: 'Almond Croissant', category: 'Pastries', price: 150, description: 'Buttery, flaky croissant filled with almond frangipane cream.', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038024a?w=500', rating: 4.8 },
                ...
                { name: 'Strawberry Frosted', category: 'Donuts', price: 95, description: 'Fluffy donut with strawberry icing and white drizzle.', image: 'https://images.unsplash.com/photo-1556805750-fa46c0665e49?w=500', rating: 4.4 },
                ...
                { name: 'Jelly Filled', category: 'Donuts', price: 90, description: 'Powdered sugar donut bursting with sweet berry jam inside.', image: 'https://images.unsplash.com/photo-1585652757141-8837d027e330?w=500', rating: 4.5 },
                ...
                { name: 'Nutella Brownie', category: 'Brownies', price: 185, description: 'Loaded with Nutella swirls and topped with crushed hazelnuts.', image: 'https://images.unsplash.com/photo-1612886623762-7f0f6df3e8b4?w=500', rating: 4.8 },
